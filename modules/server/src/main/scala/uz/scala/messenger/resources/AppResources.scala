...
import uz.scala.messenger.config.{AppConfig, DBConfig, RedisConfig}
...
object AppResources {
  ...
  private[this] def redisResource[F[_]: Async: Logger: MkRedis](c: RedisConfig): Resource[F, RedisClient[F]] =
